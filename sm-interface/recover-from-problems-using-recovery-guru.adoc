...
+
Wenn Sie ein Problem für eine asynchrone Spiegelgruppe oder ein Mitglied einer asynchronen Spiegelgruppe ausgewählt haben, klicken Sie auf „Löschen“, um den Fehler vom Controller zu beheben. Klicken Sie anschließend auf „erneut prüfen“, um das Ereignis aus dem Recovery Guru zu entfernen.
