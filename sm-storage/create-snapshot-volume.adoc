...
+
** Wenn Ihr Snapshot-Volumen gelesen/geschrieben wird, wird das Dialogfeld *Kapazität überprüfen* angezeigt. Gehen Sie zu  3: Reserve capacity.
** Wenn Ihr Snapshot-Volumen schreibgeschützt ist, wird das Dialogfeld *Priorität bearbeiten* angezeigt. Gehen Sie zu  4: Edit settings.
...
. Klicken Sie auf *Weiter*, und gehen Sie zu  4: Edit settings.
