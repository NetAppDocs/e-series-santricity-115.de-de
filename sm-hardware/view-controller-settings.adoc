...
** Wählen Sie das Controller-Symbol aus (neben der Dropdown-Liste *Shelf*). Wählen Sie bei Duplexkonfigurationen entweder Controller A oder Controller B im Dialogfeld aus, und klicken Sie dann auf Weiter. Das Dialogfeld Controller-Einstellungen wird geöffnet.
