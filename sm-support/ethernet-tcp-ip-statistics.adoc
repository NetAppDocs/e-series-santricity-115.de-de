...
summary: Wenn Sie Ethernet TCP/IP-Statistiken auswählen, werden die TCP-Statistiken in dieser Tabelle angezeigt. Sie können jede dieser Statistiken als RAW-Statistiken oder als Baseline-Statistiken anzeigen. 
---
